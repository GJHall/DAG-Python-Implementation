...
new_result = 'attack_0000276_seg.png' % what attack will be saved as
...
addpath('/home/garrett/MATLAB/caffe-master/caffe-rc5/DAG-master/code/new_images_for_report/virtual_seq_4_right')
% load caffe models
caffe.set_mode_gpu();
% caffe.set_mode_cpu();
caffe.set_device(0)
...
%         load(sprintf('../data/%s.mat', shape)); % load pre-defined mask
        ...
        % I need to modify the above line so that the attack is targeted.
        % to do so I need to map the classes to a numerical value.
        ...
        % 84 - person
        % 90 - car
        % 108 - wall on sidewalk
        % 118 - sky
        % 119 - shrubbery
        % 120 - sidewalk
        % 153 - pole
        % 178 - traffic light on pole
        % 190 - lane markers / cross walks
