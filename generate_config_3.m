...
load('legend_voc.mat');
addpath('/home/garrett/18_s_project/caffe-master/DAG-master/code/new_images_for_report/real')
...
if strfind(model_select, 'det')
    ...
    im_name = 'crop_bremen_000069.png';
%     im_name = 'org_1_500';
    % choose the geometric shape that you want, e.g. square, circle, strip
    % aka mask
    shape = 'mask_gray_bremen_000069_000019_seg.png.mat';
end
